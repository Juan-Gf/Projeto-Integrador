 ...
 */
public class prodCategoriaFem extends javax.swing.JFrame {

    /**
     * Creates new form prodCategoria
     */
    public prodCategoriaFem() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(prodCategoriaFem.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new prodCategoriaFem().setVisible(true);
            }
        });
    }
